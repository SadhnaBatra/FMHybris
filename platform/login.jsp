...
if(window.location.href.indexOf("qa.fmmpe-cat.com") != -1){
	window.location='http://qa.fmmpe-cat.com/fmstorefront/';
}

if(window.location.href.indexOf("fmmotorparts.com") != -1){
	if(window.location.href.indexOf("www.") != -1){
		window.location='http://www.fmmotorparts.com/fmstorefront/';
	}else{
		window.location='http://fmmotorparts.com/fmstorefront/';
	}
}

 ...
 *  
 */
package com.federalmogul.core.hmc;
...
/**
 * Provides necessary meta information about the fmcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class FmCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(FmCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.federalmogul.core.hmc.locales";

...
public class FitmentMakeValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable
{
	...
	{
		return getPropertyValue(model, "make");
	}

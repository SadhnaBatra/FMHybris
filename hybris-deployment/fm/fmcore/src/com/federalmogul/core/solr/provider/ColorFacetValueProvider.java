...
import com.federalmogul.core.enums.ColorEnum;
import com.federalmogul.falcon.core.model.ApparelSizeVariantProductModel;
import com.federalmogul.falcon.core.model.ApparelStyleVariantProductModel;
...
public class ColorFacetValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable
{
			...
			final Object model) throws FieldValueProviderException
	{
		...
		final Set<ColorEnum> colors = apparelStyleModel.getColors();

		if (colors != null && !colors.isEmpty())
		{
			final Collection<FieldValue> fieldValues = new ArrayList<FieldValue>();
			for (final ColorEnum color : colors)
			{
	...
	protected List<FieldValue> createFieldValue(final ColorEnum color, final IndexedProperty indexedProperty)
	{

...
public class FitmentYearValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable
{
	...
	{
		return getPropertyValue(model, "year");
	}

 ...
 *  
 */
package com.federalmogul.core.btg.condition.operand.valueproviders;
...
import com.federalmogul.core.model.btg.OrganizationOrderStatisticsModel;
...
public class AbstractTotalSpentByOrgOperandProvider extends AbstractOrderOperandValueProvider
{
	...
	/*
	 * @SuppressWarnings("unused") private final static Logger LOG =
	 * Logger.getLogger(AbstractTotalSpentByOrgOperandProvider.class);
	 */

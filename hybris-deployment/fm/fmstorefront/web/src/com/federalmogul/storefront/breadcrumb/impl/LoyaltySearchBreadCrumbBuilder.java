 ...
 */
public class LoyaltySearchBreadCrumbBuilder
{
			...
			throws IllegalArgumentException
	{
		...
		else
		{
			...
			categoryBreadcrumbs.add(getLoyaltyCategoryBreadcrumb(lastCategoryModel, (!emptyBreadcrumbs ? LAST_LINK_CLASS : "")));
			...
			while (!categoryModels.isEmpty())
			{
				...
				if (!(categoryModel instanceof ClassificationClassModel))
				{
					...
					{
						categoryBreadcrumbs.add(getLoyaltyCategoryBreadcrumb(categoryModel));
	...
	{
		return getLoyaltyCategoryBreadcrumb(category, null);
	}

	protected Breadcrumb getLoyaltyCategoryBreadcrumb(final CategoryModel category, final String linkClass)
	{

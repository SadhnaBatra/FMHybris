...
public class StoreBreadcrumbBuilder
{
			...
			throws IllegalArgumentException
	{
		...
		final String resolvedStoreFinderUrl = storeFinderUrl == null ? "/where-to-buy" : storeFinderUrl;
			...
			throws IllegalArgumentException
	{
		...
		final String storeFinderLinkName = getMessageSource().getMessage("storeFinder.link", null,
				getI18nService().getCurrentLocale());
		breadcrumbs.add(new Breadcrumb("/where-to-buy", storeFinderLinkName, null));

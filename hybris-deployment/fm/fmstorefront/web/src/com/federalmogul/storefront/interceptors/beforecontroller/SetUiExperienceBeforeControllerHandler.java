...
public class SetUiExperienceBeforeControllerHandler implements BeforeControllerHandler
{
			...
			final HandlerMethod handler)
	{
		if (isGetMethod(request))
		{
			...
			final UiExperienceLevel detectedUiExperienceLevel = uiExperienceService.getDetectedUiExperienceLevel();

			if (detectedUiExperienceLevel.equals(UiExperienceLevel.MOBILE))
			{
				final UiExperienceLevel uiExperienceLevel = enumerationService
						.getEnumerationValue(UiExperienceLevel.class, "Desktop");
				uiExperienceService.setDetectedUiExperienceLevel(uiExperienceLevel);
			}
			...
			System.err.println("uiExperienceLevel  :: "+uiExperienceLevel);

...
public class EnhancedCookieGenerator extends CookieGenerator
{
	...
	public void addCookieWithValueAsIs(final HttpServletResponse response, final String cookieValue) {
		super.addCookie(new HttpServletResponseWrapper(response) {
			...
			public void addCookie(final Cookie cookie) {
				...
				if (isHttpOnly()) {
					...
					SimpleValueServerCookie.appendCookieValue(headerBuffer, cookie.getVersion(), cookie.getName(), cookie.getValue(),
							cookie.getPath(), cookie.getDomain(), cookie.getComment(), cookie.getMaxAge(), false,
							false);

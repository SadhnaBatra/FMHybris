...
import com.federalmogul.storefront.breadcrumb.impl.StoreBreadcrumbBuilder;
...
public class StorePageController extends AbstractPageController
{
	...
	private static final String REDIRECT_STORE_FINDER = REDIRECT_PREFIX + "/where-to-buy";
		...
		if (sourceLatitude != null && sourceLongitude != null)
		{
			...
			try
			{
				...
				if (locationQuery != null && !locationQuery.isEmpty())
				{
					...
					final String storeFinderSearchUrl = UriComponentsBuilder.fromPath("/where-to-buy").queryParam("q", locationQuery)
							.build().toString();
				...
				else
				{
					...
					final String storeFinderSearchUrl = UriComponentsBuilder.fromPath("/where-to-buy/position")

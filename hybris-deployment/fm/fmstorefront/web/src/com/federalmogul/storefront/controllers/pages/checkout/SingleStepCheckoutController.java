...
import com.federalmogul.storefront.breadcrumb.impl.ContentPageBreadcrumbBuilder;
...
import com.federalmogul.storefront.forms.PaymentDetailsForm;
import com.federalmogul.storefront.forms.PlaceOrderForm;
import com.federalmogul.storefront.forms.validation.PaymentDetailsValidator;
...
public class SingleStepCheckoutController extends AbstractCheckoutController
{
	 ...
	 * Logger.getLogger(SingleStepCheckoutController.class);
	 */
	...
	public String checkoutSummary(final Model model) throws CMSItemNotFoundException
	{
		...
		// Pending:Make configuration hmc driven than hardcoding in controllers
		...
		if (!model.containsAttribute("placeOrderForm"))
		{
			...
			// Pending: Make setting of default recurrence enum value hmc driven rather hard coding in controller
			...
			throws CMSItemNotFoundException, InvalidCartException, ParseException, CommerceCartModificationException
	{
		...
		for (final CommerceCartModification cartModification : cartModifications)
		{
			...
			// Pending: handle more specific messaging, i.e. out of stock, product not available
		}

...
<%-- 
	...
	<div
		...
		<div class="cart clearfix">
			...
			<form id="addToCartForm${product.code}"
				...
				class="add_to_cart_form clear_fix">
 ...
 <div class="thumbnail">
	...
	<div class="caption">
		<h4>
			<a href="productDetail.html">${product.name}</a>
		</h4>
		<span>Part No: ${product.code}<b class="review">${fn:length(product.reviews)} Reviews</b></span>
		<p>${product.summary}</p>
		<span class="price-text-color"><format:price
							priceData="${product.price}" /></span> <a href="#"
			class="btn btn-fmDefault">Add to Cart</a>

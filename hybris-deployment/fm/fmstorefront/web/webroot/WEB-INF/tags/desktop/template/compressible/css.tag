...
<link rel="stylesheet" type="text/css" media="all" href="${commonResourcePath}/css/bootstrap.css"/>
<link rel="stylesheet" type="text/css" media="all" href="${commonResourcePath}/css/bootstrap-slider.css"/>
<link rel="stylesheet" type="text/css" media="all" href="${commonResourcePath}/css/datepicker.css"/>
<link rel="stylesheet" type="text/css" media="all" href="${commonResourcePath}/css/bootstrap-toggle.min.css"/>
<link rel="stylesheet" type="text/css" media="all" href="${commonResourcePath}/css/font-awesome.min.css"/>
<link rel="stylesheet" type="text/css" media="all" href="${commonResourcePath}/css/font-dinpro.css"/>
<link rel="stylesheet" type="text/css" media="all" href="${commonResourcePath}/css/jquery.bxslider.css"/>
<link rel="stylesheet" type="text/css" media="all" href="${commonResourcePath}/css/custom.css"/>
...
<link rel="stylesheet" type="text/css" media="all" href="${commonResourcePath}/css/jquery.range.css"/>
<link rel="stylesheet" type="text/css" media="all" href="${commonResourcePath}/css/star-stylesheet.css"/>


<%-- Start of Annonymous Homepage CSS --%>
	
	
<%-- End of Annonymous Homepage CSS --%>

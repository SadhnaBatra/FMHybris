  ...
  <div class="container companyOverview">
    <div class="row"> 
      ...
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"> 
        ...
        <div class="panel panel-default manageAccountLinks clearfix" >
          <div class="panel-body">
            <h4 class="text-uppercase" >Executive Team</h4>
            
		
		
            <ul>
            <c:forEach var="component" items="${slots.CompanySection7.cmsComponents}" varStatus="status">
		
   			<li >
   			<c:url value="/about-us/executive/${component.uid}?complnkname=${component.name}" var="aboutusURL" />
   			<c:choose>
			...
			<c:when test="${ (componentUid eq null) and (component.uid eq 'search-jobs') }">
      ...
      <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 internalLanding">
        ...
        <div id=defaultshow >
        <c:forEach begin="0" end="${slots.CompanySection7.cmsComponents.size()}" var="component" items="${slots.CompanySection7.cmsComponents}">
       ...
       <c:if test="${ componentUid eq null }">
       	<c:set var="component" value="${slots.CompanySection7.cmsComponents.get(0)}">
       	</c:set>

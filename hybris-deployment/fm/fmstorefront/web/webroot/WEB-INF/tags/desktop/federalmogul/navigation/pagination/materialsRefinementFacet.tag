	...
	<div class="panel-heading acc-heading">
		<h4 class="panel-title">
			<a class="accordion-toggle  collapsed" data-toggle="collapse"
				...
				class="acc-title">Materials</span> <span
			...
			<form class="form-horizontal" role="form">
				<div class="form-group">
					<ul class="filter-option">
						<li><input type="checkbox" checked value=""> <label>Ceramic</label>
						</li>
						<li><input type="checkbox" value=""> <label>Aluminum</label>
						</li>
						<li><input type="checkbox" value=""> <label>Steel</label>
						</li>
					</ul>
				</div>
			</form>

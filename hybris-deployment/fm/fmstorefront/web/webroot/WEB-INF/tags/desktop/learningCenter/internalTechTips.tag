  ...
  <div class="container companyOverview">
    <div class="row"> 
        ...
        <div class="panel panel-default manageAccountLinks clearfix" >
          <div class="panel-body">
           ...
           <%--  <ul >
            ...
            <c:forEach var="component" items="${slots.LearningCenterLinksSectionTT.cmsComponents}" varStatus="status">
		
   			<li >
   			<c:url value="/lc/tech-tips/${component.uid}?complnkname=${component.name}" var="learningcenterURL" />
   			<c:choose>
      ...
      <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 internalLanding">
        ...
        <div id=defaultshow >
        <c:forEach begin="0" end="${slots.LearningCenterLinksSectionTT.cmsComponents.size()}" var="component" items="${slots.LearningCenterLinksSectionTT.cmsComponents}">
       ...
       <c:if test="${ componentUid eq null }">
       	<c:set var="component" value="${slots.LearningCenterLinksSectionTT.cmsComponents.get(2)}">
       	</c:set>

  ...
  <div class="container champion">
    <div class="row"> 
      ...
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"> 
        ...
        <div class="panel panel-default manageAccountLinks clearfix" >
          <div class="panel-body">      
             <cms:slot  var="feature" position="AncoCompanySection">
             <c:choose>
             
      <c:when test="${feature.uid=='FMBrandlandingImage4'}">
      ...
      <cms:component component="${feature}" />
          ...
          <c:when test="${feature.uid=='AncoUrl'}">
      ...
      <div class="championLeftImagePanel"> 
   	...
   	<c:when test="${feature.uid != 'abexUrl' && feature.uid !='FMBrandlandingImage4'}">
    <c:set var="fmComponentName" value="ancoUrl" scope="session" />
      	<!--<div class="championLeftImagePanel"> 
 		</div> -->
          <c:if test="${count == 1 }" >
          	...
          	<c:set var="count" value="${count + 1 }" />          <ul class="">
      ...
      <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 internalLanding">
        ...
        <!-- <div class="internalPage rightHandPanel clearfix"> --> 
         ...
         <cms:slot  var="feature" position="AncoInternalContentSection">
             <cms:component component="${feature}" /> 
              </cms:slot>          

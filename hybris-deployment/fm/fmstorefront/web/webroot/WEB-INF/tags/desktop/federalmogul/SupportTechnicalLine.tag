    ...
    <div class="row"> 
      ...
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 contentLHS"> 
        ...
        <div class="panel panel-default manageAccountLinks clearfix" >
          ...
          <h3 class="text-uppercase">Technical line</h3>
              <div class="panel-group sidebar visible-lg visible-md visible-sm productlist-lhs" id="accordion"> 
                ...
                <div class="panel panel-default">
                <c:forEach var="component" items="${slots.SupportTechnicalSection.cmsComponents}" varStatus="status">	
             
                  <div class="acc-heading1">            
                   <c:url value="/support/technical-line/${component.uid}?complnkname=${component.name}" var="aboutusURL" />  
                   ...
                   <c:choose>
                    ...
                    <c:otherwise>
						<c:choose>
				           <c:when test="${componentUid eq null and  component.name eq 'Technical Line'}" >
                 ...
                 <c:if test="${comParagraphCount > 1 }">
                  <div id="detail-${status.count}" ${selMenu == 'true' and comParagraphCount > 2 ? 'style="display:block"' : 'style="display:none"'} >
                      ...
                      <form class="form-horizontal" role="form">
                        <div class="form-group btmMrgn_0">
                          <ul class="filter-option">
                            ...
                            <c:url value="/support/technical-line/${componentList.uid}?complnkname=${componentList.name}" var="aboutusURLNew" />
                          <c:choose>
     ...
     <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 internalLanding">
        ...
        <div id=defaultshow >
        <c:forEach begin="0" end="${slots.SupportTechnicalSection.cmsComponents.size()}" var="component" items="${slots.SupportTechnicalSection.cmsComponents}">
       ...
       <c:if test="${ componentUid eq null }">
       	<c:set var="component" value="${slots.SupportTechnicalSection.cmsComponents.get(0)}">
       	</c:set>

  ...
  <div class="container champion">
    <div class="row"> 
      ...
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"> 
        ...
        <div class="panel panel-default manageAccountLinks clearfix" >
          <div class="panel-body">      
             <cms:slot  var="feature" position="AbexCompanySection">
   
             <c:choose>
             
      <c:when test="${feature.uid=='FMBrandlandingImage3'}">
      ...
      <cms:component component="${feature}" />
         ...
         <c:when test="${feature.uid=='AbexUrl'}">
          <!--- <c:set var="fmComponentName" value="abexUrl" scope="session" /> -->
      <div class="championLeftImagePanel"> 
        <c:if test="${feature.url!=null}">
     	<a class="fa fa-sign-out orderPdf"><cms:component component="${feature}" /> </a>
           ...
           <!--- <h4 class="text-uppercase">123456Browse Parts</h4> -->
      </c:when>
   	<c:when test="${feature.uid != 'abexUrl' && feature.uid !='FMBrandlandingImage3'}">
   	<c:set var="fmComponentName" value="abexUrl" scope="session" />
      ...
      <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 internalLanding">
        ...
        <!-- <div class="internalPage rightHandPanel clearfix"> -->
         ...
         <cms:slot  var="feature" position="AbexInternalContentSection">
             <cms:component component="${feature}" /> 
              </cms:slot>          

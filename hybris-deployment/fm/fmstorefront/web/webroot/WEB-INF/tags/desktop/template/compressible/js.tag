...
<script type="text/javascript" src="${commonResourcePath}/js/fm.useraddress.js"></script>

<script type="text/javascript" src="${commonResourcePath}/js/acc.userlocation.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/fm.loyaltysurvey.js"></script>
<%-- Custom ACC JS --%>
<script type="text/javascript" src="${commonResourcePath}/js/acc.track.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/fm.ymmsearch.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/fm.loyaltyproductdetails.js"></script>
...
<script type="text/javascript" src="${commonResourcePath}/js/fm.locations.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/datepicker.js"></script>
...
<%-- Start of Anonymous Homepage --%>
	<script type="text/javascript" src="${commonResourcePath}/js/jquery-1.11.1.min.js"></script>
	<script type="text/javascript" src="${commonResourcePath}/js/holder.js"></script>
	<script type="text/javascript" src="${commonResourcePath}/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="${commonResourcePath}/js/bootstrap-slider.js"></script>
	<script type="text/javascript" src="${commonResourcePath}/js/easyResponsiveTabs.js"></script>
	<script type="text/javascript" src="${commonResourcePath}/js/bootstrap-toggle.min.js"></script>
	<script type="text/javascript" src="${commonResourcePath}/js/jquery.slimscroll.js"></script>
	<script type="text/javascript" src="${commonResourcePath}/js/bootstrap-datepicker.js"></script>
	<script type="text/javascript" src="${commonResourcePath}/js/bootstrap-maxlength.js"></script>
	<script type="text/javascript" src="${commonResourcePath}/js/jquery.elevatezoom.js"></script>
	<script type="text/javascript" src="${commonResourcePath}/js/custom.js"></script>
	<script type="text/javascript" src="${commonResourcePath}/js/jquery.tablesorter.js"></script>	
	<script type="text/javascript" src="${commonResourcePath}/js/registrationvalidation.js"></script>
	<script type="text/javascript" src="${commonResourcePath}/js/fm.myfmaccount.js"></script>
	<script type="text/javascript" src="${commonResourcePath}/js/jquery.bxslider.js"></script>
	<script type="text/javascript" src="${commonResourcePath}/js/password_strength_error.js"></script>

	<script type="text/javascript" src="${commonResourcePath}/js/jquery.easing.1.3.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/jquery.range.js"></script>
<%-- End of Anonymous Homepage --%>

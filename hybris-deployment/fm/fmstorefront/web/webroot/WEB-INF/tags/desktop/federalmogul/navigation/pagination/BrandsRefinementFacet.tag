	...
	<div class="panel-heading acc-heading">
		<h4 class="panel-title">
			<a class="accordion-toggle  collapsed" data-toggle="collapse"
				...
				class="acc-title">Brands</span> <span
			...
			<form class="form-horizontal" role="form">
				<div class="form-group">
					<ul class="filter-option">
						<li><input type="checkbox" checked value=""> <label>Fel-Pro</label>
						</li>
						<li><input type="checkbox" value=""> <label>Champion
						</label></li>
						<li><input type="checkbox" value=""> <label>Wanger</label>
						</li>
						<li><input type="checkbox" value=""> <label>Feredo</label>
						</li>
						<li><input type="checkbox" value=""> <label>Abex</label>
						</li>
					</ul>
				</div>
			</form>

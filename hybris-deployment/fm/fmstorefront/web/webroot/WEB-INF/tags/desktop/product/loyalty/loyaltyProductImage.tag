...
<div class="prodMainImg">
	...
	<c:if test="${empty galleryImages }">
		<img id="noProdMainImg"
			src="/fmstorefront/_ui/desktop/theme-green/images/missing-product-1200x1200.jpg"
	...
	<div class="col-md-10">
		<div id="Carousel" class="carousel slide prdDetailThumbCarousel">
					...
					<div class="item ${(varStatus.index==0)? "active":""}">
						<div class="row">
							...
							<div class="col-md-4 col-xs-4">
								<a href="#" class="thumbnail ${(varStatus.index==0)? "
									active":""}" 
			...
			<c:if test="${(galleryLength)>3}">
				...
				<a data-slide="next" href="#Carousel" class="right carousel-control"><span
				...
				<div id="thumbnail-preview-indicators" class="carousel slide"
						...
						<c:forEach items="${galleryImages}" var="container"
							...
							<li data-target="#thumbnail-preview-indicators"
								...
								<div class="thumbnail" style="padding: 0;">
									<img class="img-responsive" src="${container.thumbnail.url}"
										style="width: 68px; width: 6.8rem; height: 68px; height: 6.8rem;">
								</div>
							</li>
						</c:forEach>
					</ol>
					<c:if test="${(galleryLength)>3}">
						...
						<a class="right carousel-control"
							...
							style="margin-left: 3rem !important; margin-left: 30px !important;"></span></a>
					</c:if>
				</div>
			</div>
		</div>

...
<section class="accountDetailPage pageContet" >
  <div class="container champion">
    <div class="row"> 
      ...
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"> 
        ...
        <div class="panel panel-default manageAccountLinks clearfix" >
          <div class="panel-body">      
             <cms:slot  var="feature" position="FPDCompanySection">
             
             <c:choose>
             
      <c:when test="${feature.uid=='FMBrandlandingImage6'}">
      ...
      <c:when test="${feature.uid=='FpDieselUrl'}">
      ...
      <div class="championLeftImagePanel"> 
   	...
   	<c:when test="${feature.uid != 'FpDieselUrl' && feature.uid !='FMBrandlandingImage6'}">
      ...
      <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 internalLanding">
        ...
        <!--  <div class="internalPage rightHandPanel clearfix"> -->
         ...
         <cms:slot  var="feature" position="FPDInternalContentSection">
             <cms:component component="${feature}" /> 
              </cms:slot>          

  ...
  <div class="container companyOverview">
    <div class="row"> 
      ...
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"> 
        ...
        <div class="panel panel-default manageAccountLinks clearfix" >
          ...
          <%--   <ul >
            ...
            <c:forEach var="component" items="${slots.LearningCenterLinksSectionTO.cmsComponents}" varStatus="status">
		
   			<li >
   			
   			<c:url value="/lc/training-options/${component.uid}?complnkname=${component.name}" var="learningcenterURL" />
   			<c:choose>
      ...
      <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 internalLanding">
        ...
        <div id=defaultshow >
        <c:forEach begin="0" end="${slots.LearningCenterLinksSectionTO.cmsComponents.size()}" var="component" items="${slots.LearningCenterLinksSectionTO.cmsComponents}">
       ...
       <c:if test="${ componentUid eq null }">
       	<c:set var="component" value="${slots.LearningCenterLinksSectionTO.cmsComponents.get(0)}">
       	</c:set>

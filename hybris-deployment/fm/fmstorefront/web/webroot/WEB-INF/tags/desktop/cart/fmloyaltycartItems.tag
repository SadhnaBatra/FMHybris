...
<table id="myTable" class="table tablesorter">
	<thead>
		<tr>
			<th class="col-md-5" colspan="3"><spring:theme
					code="basket.page.title" /></th>
			<!-- <th class="col-md-3">Delivery Method</th> -->
			<th class="col-md-1 text-center"><spring:theme code="Points" /></th>
			<th class="col-md-2 text-center"><spring:theme
					code="basket.page.quantity" /></th>
			<th class="col-md-1 text-center"><spring:theme
					code="Total Points" /></th>
		</tr>
	</thead>
	<tbody>
		  	...
		  	<c:choose>
		  		<c:when test="${not entry.product.multidimensional}" > 
		  			<tr>
							...
							<div class="shoppingCartsubHead">
								<ycommerce:testId code="cart_product_name">
									...
									<h4 class="fm_fntRed miniCartProdName"> 
										<a href="${productlink}">${entry.product.name}</a> 
									</h4>
								</ycommerce:testId>
		  				...
		  				<td class="col-md-1 ">
							<div class="shoppingCartRate text-center"><fmt:formatNumber type="number" value="${entry.product.loyaltyPoints}" /> </div>
						</td>
								 ...
								 <div class="">
									<c:url value="/loyaltycart/update" var="cartUpdateFormAction" />
										...
										<ycommerce:testId code="cart_product_quantity">
											...
											<c:if test="${entry.updateable}" >
												<form:input disabled="${not entry.updateable}" type="text" maxlength="5" size="1" id="quantity${entry.entryNumber}" class="form-control updateInput width58 text-center" path="quantity" onkeypress="return isNumber(event);"/>
											</c:if>
										</ycommerce:testId>
										<c:if test="${entry.updateable}" >
											<ycommerce:testId code="cart_product_updateQuantity">
												<div class="addNewAddLink shoppingCartQuantityLink shoppingCartQuantityLinkMargin text-center lftMrgn_5">
									...
									<c:if test="${entry.updateable}">
										<ycommerce:testId code="cart_product_removeProduct">
											<div
												class="addNewAddLink shoppingCartQuantityLink shoppingCartQuantityLinkMargin text-center lftMrgn_5">
						...
						<td class="col-md-1 text-right">
							<div class="shoppingCartRate text-right">
								...
								<ycommerce:testId code="cart_totalProductPrice_label">
										...
										<fmt:formatNumber type="number" value="${entry.product.loyaltyPoints * entry.quantity}" />
								</ycommerce:testId>
							</div>
					  </td>
		  			</tr>
								 ...
								 <div class="">
									<c:url value="/loyaltycart/update" var="cartUpdateFormAction" />
										...
										<ycommerce:testId code="cart_product_quantity">
											...
											<c:if test="${entry.updateable}" >
												<form:input disabled="${not entry.updateable}" type="text" maxlength="5" size="1" id="quantity${varientEntry.entryNumber}" class="form-control  updateInput width58 text-center " path="quantity" 
						...
						<td class="col-md-1 text-right">
							<div class="shoppingCartRate text-right">
								...
								<ycommerce:testId code="cart_totalProductPrice_label">
									...
									<fmt:formatNumber type="number" value="${entry.product.loyaltyPoints * varientEntry.quantity}" />
				...
				<tr class="orderSubTotalRow">
						...
						<td colspan="2" class="text-right">
							<p class="">
								<span class="shoppingSubTotal"> Subtotal</span>
							</p>
						</td>
						<td><p class="shoppingCartTotal fm_fntRed">
							<ycommerce:testId code="Order_Totals_Subtotal">
								
								<fmt:formatNumber type="number" value="${totalReedemPoints}" />

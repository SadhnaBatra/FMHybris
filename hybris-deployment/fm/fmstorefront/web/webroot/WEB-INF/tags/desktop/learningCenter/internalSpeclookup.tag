  ...
  <div class="container companyOverview">
    <div class="row"> 
      ...
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"> 
        ...
        <div class="panel panel-default manageAccountLinks clearfix" >
          <div class="panel-body">
            ...
            <c:forEach var="component" items="${slots.LearningCenterLinksSectionSL.cmsComponents}" varStatus="status">
		
   			<li >
   				<c:url value="/lc/speclookup/${component.uid}?complnkname=${component.name}" var="learningcenterURL" />
   				<c:choose>
					...
					<c:when test="${ (componentUid eq null) and (component.uid eq 'speclookup') }">
   						<a href="${ learningcenterURL}" class="selected"> ${component.name}  <span class="linkarow fa fa-angle-right "></span> </a>
   					</c:when>
      ...
      <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 internalLanding">
        ...
        <div id=defaultshow >
        <c:forEach begin="0" end="${slots.LearningCenterLinksSectionSL.cmsComponents.size()}" var="component" items="${slots.LearningCenterLinksSectionSL.cmsComponents}">
       ...
       <c:if test="${ componentUid eq null }">
       	<c:set var="component" value="${slots.LearningCenterLinksSectionSL.cmsComponents.get(7)}">
       	</c:set>

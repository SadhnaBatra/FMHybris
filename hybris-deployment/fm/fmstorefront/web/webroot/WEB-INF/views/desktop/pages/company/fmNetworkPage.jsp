					...
					<div class="panel panel-default messagingPanel clearfix">
						<div class="lms_intro_hover ">
							...
							<div class="caption">
								<div class="blur"></div>
								<div class="caption-text">
									<h5 ><span class="fa fa-youtube-play"></span> <spring:theme code="text.company.caption4" text="VIDEO: Vehicles - Change in Miles Driven"/> </h5>
									<div class="downloadLink"><a href="#"> <spring:theme code="text.company.caption5" text="Download [358 Kb]"/> <span class="fa fa-angle-right "></span></a></div>
									<p class="lms_desc"><spring:theme code="text.company.caption6" text="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."/> </p>
									<div class="lms_btm_link"> <span class="pull-left  text-capitalize"><a href="#"><spring:theme code="text.company.caption7" text="Play" />  <span class="fa fa-angle-right "></span></a></span> <span class="pull-right  text-capitalize"><a href="#"><span class="fa fa-share-alt"> </span></a></span></div>
								</div>
							</div>
						</div>
					</div>

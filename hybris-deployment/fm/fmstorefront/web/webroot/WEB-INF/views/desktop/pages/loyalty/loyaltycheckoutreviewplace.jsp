    ...
    <div class="row">
      <div class="col-xs-12 checkoutSteps">
        <ul class="nav nav-pills nav-justified thumbnail setup-panel">
          ...
          <li class="active"><a href="#step-2">Review & Place Order</a><span class="chevron"></span></li>
  ...
  <div class="clearfix bgwhite setup-content" id="step-2">
      <div class="row">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 rgtPad_0">
                ...
                <div class="reviewFirstPanelMargin lftPad_10">
                  ...
                  <p>${shipToAddress.town},&nbsp;${shipToAddress.region.isocode}&nbsp;${shipToAddress.postalCode}&nbsp;${shipToAddress.country.isocode}</p>
                      ...
                      <div class="table-responsive userTable topMargn_20">
                        <table class="table tablesorter shipmentTable">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td colspan="2"></td>
                              <td colspan="2" class="text-center"><span class="shoppingSubTotal"> Total Redeemed Points</span></td>
        ...
        <div class="reviewPlaceOrderBtn col-lg-12">
         <c:url value="/loyalty/checkout/orderconfirm" var="encodedUrl" />
            <a href="${encodedUrl}" id="btn-fm-rp-placeorder" class="btn btn-sm btn-fmDefault text-uppercase pull-right rghtMrgn_20">Place order</a> 
             <c:url value="/loyalty/checkout" var="encodedUrl1" />
               <a href="${encodedUrl1}" id="btn-fm-rp-placeorder" class="btn btn-sm btn-fmDefault btn-fm-Grey text-uppercase pull-right">Return to Shipping Address</a> 

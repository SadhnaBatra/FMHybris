...
<template:page pageTitle="${pageTitle}">
			...
			<div class="row">
				<div class="col-xs-12 checkoutSteps">
					<ul class="nav nav-pills nav-justified thumbnail setup-panel">
						<li class="active"><a href="#step-1"><spring:theme code="checkout.page.tabs.billingShipping"/></a><span class="chevron"></span></li>
						<li class="disabled"><a href="#step-2"><spring:theme code="checkout.page.tabs.deliveryMethod"/></a><span class="chevron"></span></li>
	...
	<section itemtype="http://schema.org/Product" itemscope="" class="breadcrumbPanel visible-lg visible-md visible-sm">
		<div class="container">
			<div class="row">
				<ul class="breadcrumb">
					<li><a href="index.html"> <span class="fa fa-home"></span> <spring:theme code="checkout.page.home"/></a> <i class="fa fa-angle-right "></i></li>
					<li><a itemprop="url" class="text-capitalize" href="#"><spring:theme code="checkout.page.shoppingCart"/></a> <i class="fa fa-angle-right "></i></li>
					<li><a itemprop="url" class="selected text-capitalize" href="#"><spring:theme code="checkout.page.checkout"/></a></li>
				</ul>
			</div>
		</div>
	</section>

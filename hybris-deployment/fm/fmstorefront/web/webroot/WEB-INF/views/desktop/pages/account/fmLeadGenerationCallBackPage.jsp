		...
		<div class="container manageAccount">
			<div class="row">
					...
					<%-- <div class="panel panel-default messagingPanel clearfix">
						<div class="lms_intro_hover ">
							...
							<div class="caption">
								...
								<div class="caption-text">
									<h5>
										<span class="fa fa-youtube-play"></span> VIDEO: Vehicles -
										Change in Miles Driven
									</h5>
									<div class="downloadLink">
										<a href="#"> Download [358 Kb] <span
											class="fa fa-angle-right "></span></a>
									</div>
									<p class="lms_desc">Lorem ipsum dolor sit amet, consectetur
										adipiscing elit, sed do eiusmod tempor incididunt ut labore et
				...
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 ">
					<div
						class="manageUserPanel manageUserSection rightHandPanel clearfix">

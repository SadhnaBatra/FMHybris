				...
				<div class="col-xs-12 checkoutSteps">
					<ul class="nav nav-pills nav-justified thumbnail setup-panel">
						<c:if test="${customerType eq 'b2cCustomer'}">
							<li class="complete active"><a href="#step-1"><spring:theme code="checkout.page.tabs.billingShipping"/></a><span class="chevron"></span></li>
							<li class="complete active"><a href="#step-2"><spring:theme code="checkout.page.tabs.deliveryMethod"/></a><span class="chevron"></span></li>
							<li class="complete active"><a href="#step-3"><spring:theme code="checkout.page.tabs.paymentDetails"/></a><span class="chevron"></span></li>
							<!-- <li class="complete active"><a href="#step-4"><spring:theme code="checkout.page.tabs.reviewPlaceOrder"/></a><span class="chevron"></span></li> -->
							<li class="complete active"><a href="#step-5"><spring:theme code="checkout.page.tabs.orderConfirmation"/></a></li>
						</c:if>
						...
						<c:if test="${customerType eq 'b2bCustomer' or customerType eq 'b2BCustomer' or customerType eq 'CSRCustomer'}">
							...
							<!--<li class="complete active"><a href="#step-2">Payment Details</a><span class="chevron"></span></li>-->
							<!-- <li class="complete"><a href="#step-2"><spring:theme code="checkout.page.tabs.reviewPlaceOrder"/></a><span class="chevron"></span></li> -->
							<li class="complete active"><a href="#step-3"><spring:theme code="checkout.page.tabs.orderConfirmation"/></a></li>
						</c:if>
					</ul>
				</div>
			</div>

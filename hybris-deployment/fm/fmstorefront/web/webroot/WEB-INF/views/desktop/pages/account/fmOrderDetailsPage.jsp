  ...
  <div class="container">
	...
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
				...
				<div class="">
					...
					<c:set var="fmComponentName" value="insight" scope="session" />
					<div class="panel panel-default messagingPanel clearfix" style="display: none">
						<div class="lms_intro_hover ">
							<p>
								<cms:pageSlot position="Announcement1" var="feature">
									<cms:component component="${feature}" />
				...
				<c:set var="userGroup" scope="session" value="${userGroup}"/>
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 ">
					<div
						class="packageSlipPanel  rightHandPanel orderPackingSlipDetails clearfix">
						<c:choose>
							<c:when
								test="${customerType eq 'b2BCustomer' or customerType eq 'CSRCustomer'}">
								<federalmogul:orderDetails_B2B />
							</c:when>
							<c:otherwise>
								<federalmogul:orderDetails />
							</c:otherwise>
						</c:choose>
					</div>
				</div>

	...
	<div class="column companyContentPane clearfix orderList">
		...
		<div class="right">
			<ycommerce:testId code="User_AddUser_button">
				<a href="${manageUsersUrl}" class="button add"><spring:theme
						code="text.company.manageUser.button.create"
						text="Create New User" /></a>
			</ycommerce:testId>
		</div>
		<div class="description">
			<spring:theme code="text.company.manageusers.subtitle"
				arguments="${b2bStore}" />
		</div>
		...
		<c:if test="${not empty searchPageData.results}">
			<p>
				<spring:theme code="text.company.manageUser.viewUsers"
					text="View Users" />
			</p>
					...
					<thead>
						<tr>
							<th id="header1"><spring:theme
									code="text.company.column.name.name" text="Name" /></th>
							<th id="header2"><spring:theme
									code="text.company.column.roles.name" text="Roles" /></th>
							<th id="header3"><spring:theme
									code="text.company.column.parentUnit.name" text="Parent Unit" />
							</th>
							<th id="header4"><spring:theme
									code="text.company.manageUser.user.costCenter"
									text="Cost center" /></th>
							<th id="header5"><spring:theme
									code="text.company.status.title" text="Status" /></th>
						...
						<c:forEach items="${searchPageData.results}" var="user">
							<tr>
								...
								<td headers="header1"><ycommerce:testId
										...
										<p>
											<a href="${viewUserUrl}">${user.firstName}&nbsp;${user.lastName}</a>
										</p>
									</ycommerce:testId></td>
								...
								<td headers="header4"><ycommerce:testId
										code="my-company_user_costcenter_label">

...
import com.fm.constants.FmintegrationConstants;
import com.fm.jalo.GeneratedFmintegrationManager;



/**
 * This is the extension manager of the Fmintegration extension.
 */
public class FmintegrationManager extends GeneratedFmintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FmintegrationManager.class.getName());
	 ...
	 */
	public static FmintegrationManager getInstance()
	{
		return (FmintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(FmintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FmintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FmintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FmintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FmintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}

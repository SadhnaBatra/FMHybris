 ...
 * 
 */
public class FMB2BBRegistrationApprovalContext extends AbstractEmailContext<FMB2BBRegistrationApprovalProcessModel>
{
	...
	private static final Logger LOG = Logger.getLogger(FMB2BBRegistrationApprovalContext.class);
	...
	@Override
	public void init(final FMB2BBRegistrationApprovalProcessModel businessProcessModel, final EmailPageModel emailPageModel)
	{
	 ...
	 */
	@Override
	protected BaseSiteModel getSite(final FMB2BBRegistrationApprovalProcessModel businessProcessModel)
	{
	 ...
	 */
	@Override
	protected CustomerModel getCustomer(final FMB2BBRegistrationApprovalProcessModel businessProcessModel)
	{
	 ...
	 */
	@Override
	protected LanguageModel getEmailLanguage(final FMB2BBRegistrationApprovalProcessModel businessProcessModel)
	{
		// YTODO Auto-generated method stub

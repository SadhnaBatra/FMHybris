 ...
 * 
 */
public class FMAdminAddNewUserContext extends AbstractEmailContext<FMAdminAddNewUserProcessModel>
{
	...
	private static final Logger LOG = Logger.getLogger(FMAdminAddNewUserContext.class);
	...
	@Override
	public void init(final FMAdminAddNewUserProcessModel businessProcessModel, final EmailPageModel emailPageModel)
	{
	 ...
	 */
	@Override
	protected BaseSiteModel getSite(final FMAdminAddNewUserProcessModel businessProcessModel)
	{
	 ...
	 */
	@Override
	protected CustomerModel getCustomer(final FMAdminAddNewUserProcessModel businessProcessModel)
	{
	 ...
	 */
	@Override
	protected LanguageModel getEmailLanguage(final FMAdminAddNewUserProcessModel businessProcessModel)
	{
		// YTODO Auto-generated method stub

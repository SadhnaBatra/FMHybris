 ...
 */
public class FMBatchLoadErrorEmailContext extends AbstractEmailContext<FMBatchLoadErrorEmailModel>
{
	...
	private static final Logger LOG = Logger.getLogger(FMBatchLoadErrorEmailContext.class);
	...
	@Override
	public void init(final FMBatchLoadErrorEmailModel businessProcessModel, final EmailPageModel emailPageModel)
	{
		...
		errors = businessProcessModel.getErrors();
	 ...
	 */
	@Override
	protected BaseSiteModel getSite(final FMBatchLoadErrorEmailModel businessProcessModel)
	{
	 ...
	 */
	@Override
	protected CustomerModel getCustomer(final FMBatchLoadErrorEmailModel businessProcessModel)
	{
		// YTODO Auto-generated method stub
	 ...
	 */
	@Override
	protected LanguageModel getEmailLanguage(final FMBatchLoadErrorEmailModel businessProcessModel)
	{
		// YTODO Auto-generated method stub

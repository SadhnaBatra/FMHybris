 ...
 *  
 */
package com.federalmogul.initialdata.setup;
...
import com.federalmogul.initialdata.constants.FmInitialDataConstants;
 ...
 */
@SystemSetup(extension = FmInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	private static final String BTG_EXTENSION_NAME = "btg";

	/*
	 * @SuppressWarnings("unused") private static final Logger LOG = Logger.getLogger(InitialDataSystemSetup.class);
	 */

	private static final String IMPORT_SAMPLE_DATA = "importSampleData";
	private static final String SAMPLE_DATA_IMPORT_FOLDER = "fminitialdata";
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		// importCommonData(context, "fminitialdata");
		// This would import a standard store: (one basestore, one cmssite, one product catalog, one content catalog)
		// importStoreInitialData(context, "fminitialdata", "yb2baccelerator", "yb2baccelerator", Collections.singletonList("yb2baccelerator"));

		if (getBooleanSystemSetupParameter(context, IMPORT_SAMPLE_DATA))
		{
			importCommonData(context, SAMPLE_DATA_IMPORT_FOLDER);

			importStoreInitialData(context, SAMPLE_DATA_IMPORT_FOLDER, "federalmogul", "federalmogul",
					Collections.singletonList("federalmogul"));
			...
			getEventService().publishEvent(new SampleDataImportedEvent(context, Arrays.asList(federalmogulImportData)));
		}
	}

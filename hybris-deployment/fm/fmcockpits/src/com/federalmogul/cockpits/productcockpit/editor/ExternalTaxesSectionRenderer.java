 ...
 *  
 */
package com.federalmogul.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("fmcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("fmcockpits.product.externalTaxes"));

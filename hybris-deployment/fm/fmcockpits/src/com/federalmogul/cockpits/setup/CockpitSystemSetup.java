 ...
 *  
 */
package com.federalmogul.cockpits.setup;
...
import com.federalmogul.cockpits.constants.FmCockpitsConstants;
 ...
 */
@SystemSetup(extension = FmCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(FmCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(FmCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						FmCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				importImpexFile(context, "/fmcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
			}

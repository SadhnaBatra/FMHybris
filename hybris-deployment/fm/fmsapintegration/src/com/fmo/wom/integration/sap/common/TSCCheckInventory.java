...
public abstract class TSCCheckInventory extends SapBapiAction{
	...
	public TSCCheckInventory(String sapAccountCode, String shipToAccountCode, 
							 ...
							 String anOrderType, String anOrderSource) {
		super();
		this.itemList = itemList;
		this.sapAccountCode = sapAccountCode;
		this.shipToAccountCode = shipToAccountCode;
	...
	public void initializeImportParams(JCoParameterList importParams) {
		...
		importParams.setValue(SapConstants.ORDER_TYPE, OrderType.EMERGENCY.getEconCode()); 
		importParams.setValue(SapConstants.ORDER_SOURCE, this.orderSource);
	...
	protected void checkReturnStructure(JCoStructure returnStructure) throws WOMExternalSystemException {
		getLogger().info("TSCCheckInventory.checkReturnStructure(JCoStructure returnStructure)");

...
/**
 * The primary key class for the NABS_SHIPPING_CODE database table.
 * 
 */
//Embeddable
public class NabsShippingCodePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof NabsShippingCodePK)) {
			return false;
		}
		NabsShippingCodePK castOther = (NabsShippingCodePK)other;
		return 

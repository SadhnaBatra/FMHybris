...
-->
	...
	<xsl:template match="/">
		<aaia:ConfirmBOD  xmlns:aaia="http://www.aftermarket.org/oagis"  xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.aftermarket.org/oagis ../BODs/ConfirmBOD.xsd" revision="1.2.1" lang="en">

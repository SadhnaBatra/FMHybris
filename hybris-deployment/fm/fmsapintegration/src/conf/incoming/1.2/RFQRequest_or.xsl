<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:default="http://www.openapplications.org/oagis" xmlns="http://www.openapplications.org/oagis" xmlns:aaia="http://www.aftermarket.org/oagis" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:oa="http://www.openapplications.org/oagis" >
	...
	<xsl:variable name="frieghtType" select="/aaia:AddRequestForQuote/default:DataArea/default:RequestForQuote/aaia:Header/default:TransportationTerm/default:FreightTerms"/>

	<xsl:template match="/aaia:AddRequestForQuote/default:DataArea/default:RequestForQuote/aaia:Header/default:Parties/default:BillToParty/default:TaxExemptInd"  />
	<xsl:template match="/aaia:AddRequestForQuote/default:DataArea/default:RequestForQuote/aaia:Header/default:Parties/default:BillToParty/default:TaxId"  />

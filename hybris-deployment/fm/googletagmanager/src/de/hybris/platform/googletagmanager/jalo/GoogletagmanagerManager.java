 ...
 *
 */
package de.hybris.platform.googletagmanager.jalo;
...
import de.hybris.platform.googletagmanager.constants.GoogletagmanagerConstants;



/**
 * This is the extension manager of the Googletagmanager extension.
 */
public class GoogletagmanagerManager extends GeneratedGoogletagmanagerManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GoogletagmanagerManager.class.getName());
	 ...
	 */
	public static GoogletagmanagerManager getInstance()
	{
		return (GoogletagmanagerManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GoogletagmanagerConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GoogletagmanagerManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GoogletagmanagerManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GoogletagmanagerManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GoogletagmanagerManager called, current tenant: " + getTenant().getTenantID());
		}
	}

 ...
 *
 */
package de.hybris.platform.googletagmanager.hmc;
...
/**
 * Provides necessary meta information about the googletagmanager hmc extension.
 * 
 * 
 * @version ExtGen v5.5.1.0
 */
public class GoogletagmanagerHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(GoogletagmanagerHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.googletagmanager.hmc.locales";

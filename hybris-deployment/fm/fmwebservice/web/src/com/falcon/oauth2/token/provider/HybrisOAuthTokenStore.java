...
package com.falcon.oauth2.token;
...
import com.falcon.oauth2.token.OAuthTokenService;
import com.falcon.util.YSanitizer;
...
public class HybrisOAuthTokenStore implements TokenStore
{
	...
	public void storeAccessToken(final OAuth2AccessToken token, final OAuth2Authentication authentication)
	{
		...
		oauthTokenService.saveAccessToken(extractTokenKey(token.getValue()), serializeAccessToken(token),
				...
				authentication.isClientOnly() ? null : authentication.getName(),null,     //authentication.getOAuth2Request().getClientId(),
				refreshTokenModel);
	}

 ...
 *  
 */
package com.federalmogul.fulfilmentprocess.test.jobs;
...
import com.federalmogul.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = FmFulfilmentProcessConstants.ORDER_PROCESS_NAME;

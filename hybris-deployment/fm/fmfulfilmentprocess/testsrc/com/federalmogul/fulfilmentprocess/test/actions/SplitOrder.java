 ...
 *  
 */
package com.federalmogul.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(FmFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(FmFulfilmentProcessConstants.PARENT_PROCESS);
